...
```
cd existing_repo
git remote add origin https://git.asmtechtn.com/czidi/projetpfe.git
git branch -M main
...
- [ ] [Set up project integrations](https://git.asmtechtn.com/czidi/projetpfe/-/settings/integrations)
